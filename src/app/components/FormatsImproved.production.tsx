          ...
          <div>
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                <div className="relative h-40 rounded-xl overflow-hidden">
                  <ImageWithFallback src={investGasUrl} alt="Газовые трубы" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#040307]/90 via-transparent to-transparent"></div>
                  <div className="absolute bottom-2 left-2 right-2">
                ...
                <div className="relative h-40 rounded-xl overflow-hidden">
                  <ImageWithFallback src={investFinanceUrl} alt="Финансы" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#040307]/90 via-transparent to-transparent"></div>
                  <div className="absolute bottom-2 left-2 right-2">
